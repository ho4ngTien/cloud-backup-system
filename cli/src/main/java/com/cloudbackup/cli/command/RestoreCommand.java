...
public class RestoreCommand implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            // NOTE: In production, the AES key would be retrieved from the server for this job.
            //       Here we generate a demo key – in real use, persist & retrieve the key per jobId.
            byte[] aesKey = CryptoUtil.generateAesKey(); // TODO: fetch from server
